/*
Modification:
Override minigun, add the following to your main:
level.overrideminigun = "weaponnameforminigun";
level.zombie_powerup_weapon[ "minigun" ] = GetWeapon( level.overrideminigun );
...
{
	if ( weapon.name != level.overrideminigun )
	{
