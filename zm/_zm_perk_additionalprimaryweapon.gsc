/*
Modification:
Added alternate hud pointer function
	level.use_alternate_hud
...
{
	if(isdefined(level.use_alternate_hud))
	{
		self [[level.use_alternate_hud]]("specialty_extraprimaryweapon_zombies", PERK_ADDITIONAL_PRIMARY_WEAPON);
	}
	else
	{
